...
L.mapbox.accessToken =
	'pk.eyJ1IjoidGZodWdoZXMiLCJhIjoiY2l0YW4yY3p1MDJpMjJubzYwaWIwbzVlOSJ9.1JIlibamCPwC32L28V42NA';
...
var map = L.mapbox.map('map', "tfhughes.1ef1lgf2").setView([46.682429, 34.452109],
	7);
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 
	$.getJSON('https://garuda3060.cloudant.com/scythians/_design/tour/',
		function(result) {
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 	
	var cloudantURLbase =
		"https://garuda3060.cloudant.com/scythians/_design/tour/_view";
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 	
	var cloudantURLbase =
		"https://garuda3060.cloudant.com/scythians/_design/tour/_search/ids?q=";
	var cloudantURLcallback = "&callback=?";
...
// ACTION ITEM: Replace cloudant database URL with URL for your database 		
		var cloudantURLbase = "https://garuda3060.cloudant.com/scythians/";
...
// ACTION ITEM: Replace mapbox id below with the mapbox id that corresponds to your georeferenced map for the view above			
		url = 'mapbox://styles/toddfhughes/civcp1bcj00682iphit2g6hjy'
	} 
